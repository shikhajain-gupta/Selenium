...
WebElement register = driver.findElement(By.xpath("//div[@class='css-vb6e92']/button[text()='Register']"));
        ...
        driver.findElement(By.id("username")).sendKeys("shikhatest3");
        Thread.sleep(1000);
        driver.findElement(By.id("password")).sendKeys("shikhatest3");
        Thread.sleep(1000);
        driver.findElement(By.id("confirmPassword")).sendKeys("shikhatest3");
        Thread.sleep(1000);
        ...
        if(url.contains("login"))
        {
            ...
            //div[@class='form css-ikzlcq']/button
            Thread.sleep(3000);
            ...
            //List<WebElement> imageText = driver.findElements(By.className("MuiTypography-root MuiTypography-body1 css-yg30e6"));
